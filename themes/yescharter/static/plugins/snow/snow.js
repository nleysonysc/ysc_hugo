let _snowCanvas = function( obj ){
    ...
    **/
    ...
    function setHeightWidth( ){
        if (typeof obj.width === 'function'){W = obj.width(canvas)}
    ...
    window.addEventListener('resize', (e) => {
        if(window?.yscGlobalResizeTimer) window.clearTimeout(window.yscGlobalResizeTimer);
        window.yscGlobalResizeTimer = window.setTimeout(function() {
            setHeightWidth();
        }, 200);
    }); 
